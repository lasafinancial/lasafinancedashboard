                    ...
                    <div className="relative rounded-2xl border border-white/10 bg-black/40 backdrop-blur-xl overflow-hidden shadow-2xl">
                        ...
                        <div className="flex items-center justify-between px-6 py-3 border-b border-white/5 bg-white/[0.02] text-xs text-white/60 font-medium">
                            ...
                            <div className="text-[11px] text-white/40 font-mono">
                                Column FV = 'Y' (within 5% of 52W Low)
                            </div>
                        </div>
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow className="border-white/10 hover:bg-transparent">
                                        ...
                                        <TableHead
                                            onClick={() => toggleSort("low52")}
                                            className="text-[11px] font-black text-white/60 uppercase tracking-widest text-right cursor-pointer hover:text-white transition-colors"
                                        >
                                            <span className="flex items-center justify-end gap-1.5">
                                                52 Week Low
                                                {sortField === "low52" && (sortDirection === "asc" ? <ChevronUp className="w-3 h-3" /> : <ChevronDown className="w-3 h-3" />)}
                                            </span>
                                        </TableHead>
                                        <TableHead
                                ...
                                <TableBody>
                                    <PremiumProtector requiredTier="pro" blurLevel="md" title="Premium Feature" description="Upgrade to view all 52 Week Low data.">
                                        {(isFree ? processedStocks.slice(0, 10) : processedStocks).map((stock) => {
                                            return (
                                                ...
                                                >
                                                    ...
                                                    {/* 52 Week Low */}
                                                    <TableCell className="py-3.5 text-right font-black tabular-nums text-sm text-rose-400">
                                                        ₹{formatNumber(stock.low52)}
                                                    </TableCell>
                                                    ...
                                                    <TableCell className="py-3.5 text-center" onClick={(e) => e.stopPropagation()}>
                                                        <button
                                                            onClick={() => handleStockClick(stock.id)}
                                                            className="p-2 rounded-xl bg-white/5 border border-white/10 hover:bg-rose-500 hover:text-white hover:border-rose-500 transition-all duration-200"
