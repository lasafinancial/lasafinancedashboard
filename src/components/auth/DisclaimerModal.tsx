                ...
                <div className="p-6 sm:p-8 space-y-6 relative max-h-[85vh] overflow-y-auto custom-scrollbar">
                    ...
                    <div className="p-5 sm:p-6 bg-muted/40 rounded-2xl border border-white/5 space-y-4">
                        <p className="text-sm sm:text-base leading-relaxed text-foreground/90 font-bold italic">
                            LASA Finance is a decision-support analytics platform. All market data, signals, scores, and insights displayed are generated by proprietary algorithms and AI models for educational and informational purposes only.
                        </p>
                        <ul className="space-y-2 text-xs sm:text-sm text-muted-foreground/90 list-disc pl-4 font-medium">
                            ...
                            <li>LASA Finance is not responsible for any financial profit or loss arising from use of this information</li>
