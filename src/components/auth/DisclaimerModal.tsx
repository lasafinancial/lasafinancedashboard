...
export function DisclaimerModal() {
    ...
    useEffect(() => {
        const checkDisclaimerStatus = async () => {
            ...
            // Show if authenticated and disclaimer hasn't been accepted in Firestore
            if (user && !userData?.disclaimerAcceptedAt) {
                setIsOpen(true);
            } else {
                setIsOpen(false);
            }
                ...
                <div className="p-6 sm:p-8 space-y-6 relative max-h-[85vh] overflow-y-auto custom-scrollbar">
                    <DialogHeader className="space-y-3">
                        <div className="flex items-center gap-3">
                            ...
                            <DialogTitle className="text-2xl font-bold tracking-tight">Important Disclaimer — Please Read</DialogTitle>
                        </div>
                    ...
                    <div className="p-5 sm:p-6 bg-muted/40 rounded-2xl border border-white/5 space-y-4">
                        <p className="text-sm sm:text-base leading-relaxed text-foreground/90 font-bold italic">
                            LASA Research Services is a decision-support analytics platform. All market data, signals, scores, and insights displayed are generated by proprietary algorithms and AI models for educational and informational purposes only.
                        </p>
                        <ul className="space-y-2 text-xs sm:text-sm text-muted-foreground/90 list-disc pl-4 font-medium">
                            <li>This platform is not a SEBI-registered Investment Adviser or Research Analyst</li>
                            <li>Content does not constitute investment advice or a recommendation to buy, sell, or hold any security</li>
                            <li>You should not rely solely on this platform for trading decisions</li>
                            <li>LASA Research Services is not responsible for any financial profit or loss arising from use of this information</li>
                            <li>Always consult a qualified and SEBI-registered financial advisor before investing</li>
                        </ul>
                        <p className="text-xs sm:text-sm text-foreground/70 font-semibold border-t border-white/5 pt-3">
