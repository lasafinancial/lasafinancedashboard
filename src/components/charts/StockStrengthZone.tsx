        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-4 text-[10px] sm:text-xs">
            <div className="flex items-center gap-1.5">
              <div className="w-3 h-2.5 sm:w-4 sm:h-3 rounded-sm bg-cyan-500/40 border border-cyan-500"></div>
              <span className="text-muted-foreground">Support-Resistance Zone</span>
            </div>
            <div className="flex items-center gap-1.5">
